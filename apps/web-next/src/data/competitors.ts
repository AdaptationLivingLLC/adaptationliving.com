...
export const competitors: Competitor[] = [
  {
    ...
    tagline:
      "Adaptation OS vs ActiveCampaign — One platform for every channel, not just email.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline:
      "Adaptation OS vs HubSpot — Enterprise power without the enterprise invoice.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline:
      "Adaptation OS vs ClickFunnels — A business platform, not just a funnel page.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline: "Adaptation OS vs Keap — Modern AI built in, not bolted on.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline: "Adaptation OS vs Linktree — A business, not just a bio link.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline:
      "Adaptation OS vs Kartra — Grow past the contact cap without switching tools.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline:
      "Adaptation OS vs Vendasta — One native platform, not a reseller bundle.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline:
      "Adaptation OS vs SharpSpring — Unlimited contacts, not contact-tiered billing.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline:
      "Adaptation OS vs Klaviyo — Stop duct-taping tools around your email list.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline:
      "Adaptation OS vs Zoho — One platform, not 40 apps to wire together.",
    ourEdge: [
  ...
  },
  {
    ...
    tagline:
      "Adaptation OS vs Salesforce — Enterprise capability without the consulting bill.",
    ourEdge: [
